...
const WpLogin = () => {
  ...
  const handleSubmit = async () => {
    try {
        ...
        .then((responseData) => {
          ...
          if (responseData.code == 200) {
            ...
            if (responseData.data.updateCount == 1) {
              ...
              localStorage.setItem("ApiBirthday", responseData.data.dateOfBirth);
              localStorage.setItem("ApiGender", responseData.data.gender);
              localStorage.setItem("ApiEmailId", responseData.data.googleSignInToken);
              localStorage.setItem("ApiName", responseData.data.name);
              localStorage.setItem("ApiResidentialArea", responseData.data.area.address);
              localStorage.setItem("Latitude", responseData.data.area.latLng.lat);
              localStorage.setItem("Longitude", responseData.data.area.latLng.lng);
              ...
              localStorage.setItem("Latitude", responseData.data.area.latLng.lat);
              localStorage.setItem("Longitude", responseData.data.area.latLng.lng);
              localStorage.setItem("ApiRelationStatus", responseData.data.relationShipStatus);
              localStorage.setItem("ApiAnniversary", responseData.data.anniversary);
              ...
              localStorage.setItem("ApiAnniversary", responseData.data.anniversary);
              localStorage.setItem("ApiAgeGroup", responseData.data.ageGroup);
              localStorage.setItem("ApiHaveFoodDeliveryApp", responseData.data.haveFoodDeliveryApp);
      ...
      alert("Please verify your contact number", "An unexpected error occurred.");
    }
  };
